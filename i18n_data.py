...
""",
        ...
        "desc_training_flux2": "Flux.2 models use Mistral (Dev) or Qwen (Klein) text encoders. Please ensure you have the correct text encoder weights.",
        # New Features
...
""",
        ...
        "desc_training_flux2": "Flux.2モデルはMistral (Dev) または Qwen (Klein) テキストエンコーダーを使用します。正しいテキストエンコーダーの重みがあることを確認してください。",
        # New Features
