...
I18N_DATA = {
    "en": {
        ...
        "app_desc": "A simple frontend for training LoRA/LoHa/LoKr and Z-Image fine-tune with Musubi Tuner.",
        ...
        "header_dataset_details": "### Dataset Details",
        "desc_dataset_details": "Optional overrides for dataset config (image/cache paths, repeats, captions, bucketing). Defaults are auto-filled.",
        "lbl_image_dir": "Image Directory",
        "ph_image_dir": "Default: project/training",
        "lbl_cache_dir": "Cache Directory",
        "ph_cache_dir": "Default: project/cache",
        "lbl_caption_ext": "Caption Extension",
        "lbl_num_repeats": "Repeats Per Image",
        "lbl_enable_bucket": "Enable Bucketing",
        "lbl_bucket_no_upscale": "Do Not Upscale Buckets",
        ...
        "desc_training_basic": "Configure the training parameters. Supports LoRA/LoHa/LoKr and Z-Image fine-tune. If you train with the same name again, the previous model output will be overwritten.",
        "desc_training_zimage": "Recommended: Use **bf16** for mixed precision. Choose the appropriate Z-Image base model checkpoint in the DiT path.",
        "btn_rec_params": "Set Recommended Parameters",
        "lbl_dit_path": "Base Model / DiT Path",
        "ph_dit_path": "Path to DiT model",
        "lbl_output_name": "Output Model Name",
        "header_basic_params": "### Basic Parameters",
        "lbl_training_mode": "Training Mode",
        "lbl_network_type": "Network Type",
        "lbl_dim": "LoRA Rank (Dim)",
        "lbl_network_args": "Network Args (Optional)",
...
""",
        ...
        "desc_post_proc": "Convert Z-Image LoRA/LoHa/LoKr to ComfyUI format.",
        ...
        "header_preset_save": "### Save Preset",
        "header_preset_load": "### Load Preset",
        ...
        "btn_open_presets": "Open Presets Folder",
        "btn_open_project": "Open Project Folder",
        "btn_open_training": "Open Training Folder",
        "btn_open_logs": "Open Logs Folder",
        "lbl_preset_apply_paths": "Apply paths from preset",
        "tag_preset": "Preset",
        "tag_project": "Project",
        "tag_paths": "Env/Paths",
        "desc_preset_scope": "Presets fill the form. Paths stay unless enabled.",
        "msg_preset_saved": "Preset saved: {name}",
        "msg_preset_loaded": "Preset loaded: {name}",
        "msg_preset_paths_kept": "Paths kept from current project/environment.",
        "msg_preset_repaired": "Legacy preset detected; sample fields repaired.",
        "msg_preset_error": "Error managing presets: {e}",
        "msg_open_path_ok": "Opened folder: {path}",
        "msg_open_path_fail": "Failed to open folder: {path}\n{e}",
        "msg_open_path_missing": "Path not found: {path}",
        ...
        "lbl_full_bf16": "Enable --full_bf16 (Fine-tune)",
        "lbl_fused_backward_pass": "Enable --fused_backward_pass (Fine-tune)",
        "lbl_mem_eff_save": "Enable --mem_eff_save (Fine-tune)",
        "lbl_block_swap_optimizer_patch_params": "Enable --block_swap_optimizer_patch_params (Fine-tune)",
        ...
        "lbl_lokr_rank": "LoKr Rank For Conversion (Optional)",
    },
    "ja": {
        "app_title": "Musubi Tuner GUI",
        "app_header": "# Musubi Tuner GUI",
        "app_desc": "Musubi TunerでLoRA/LoHa/LoKr学習とZ-Image Fine-tuneを行うためのシンプルなフロントエンドです。",
        ...
        "header_dataset_details": "### データセット詳細",
        "desc_dataset_details": "画像/キャッシュのパス、繰り返し回数、キャプション拡張子、バケット設定を上書きできます（未入力なら自動）。",
        "lbl_image_dir": "画像ディレクトリ",
        "ph_image_dir": "未入力なら project/training",
        "lbl_cache_dir": "キャッシュディレクトリ",
        "ph_cache_dir": "未入力なら project/cache",
        "lbl_caption_ext": "キャプション拡張子",
        "lbl_num_repeats": "繰り返し回数 (num_repeats)",
        "lbl_enable_bucket": "バケットを有効化",
        "lbl_bucket_no_upscale": "バケットで拡大しない",
        ...
        "desc_training_basic": "学習パラメータを設定してください。LoRA/LoHa/LoKr学習とZ-Image Fine-tuneに対応しています。同じ名前で再学習すると前回の出力が上書きされます。",
        "desc_training_zimage": "推奨: 混合精度には **bf16** を使用してください。使用するZ-Imageのベースモデル（DiT）のチェックポイントを指定してください。",
        "btn_rec_params": "推奨パラメータを設定",
        "lbl_dit_path": "ベースモデル / DiT パス",
        "ph_dit_path": "DiTモデルへのパス",
        "lbl_output_name": "出力モデル名",
        "header_basic_params": "### 基本パラメータ",
        "lbl_training_mode": "学習モード",
        "lbl_network_type": "ネットワーク種別",
        "lbl_dim": "LoRAランク (Dim)",
        "lbl_network_args": "Network Args（任意）",
...
""",
        ...
        "desc_post_proc": "Z-ImageのLoRA/LoHa/LoKrをComfyUI形式に変換します。",
        ...
        "header_preset_save": "### プリセット保存",
        "header_preset_load": "### プリセット読み込み",
        "btn_open_presets": "プリセットフォルダを開く",
        "btn_open_project": "プロジェクトフォルダを開く",
        "btn_open_training": "trainingフォルダを開く",
        "btn_open_logs": "logsフォルダを開く",
        ...
        "msg_open_path_ok": "フォルダを開きました: {path}",
        "msg_open_path_fail": "フォルダを開けませんでした: {path}\n{e}",
        "msg_open_path_missing": "パスが見つかりません: {path}",
        ...
        "lbl_full_bf16": "--full_bf16 を有効化（Fine-tune）",
        "lbl_fused_backward_pass": "--fused_backward_pass を有効化（Fine-tune）",
        "lbl_mem_eff_save": "--mem_eff_save を有効化（Fine-tune）",
        "lbl_block_swap_optimizer_patch_params": "--block_swap_optimizer_patch_params を有効化（Fine-tune）",
        ...
        "lbl_lokr_rank": "変換時 LoKr Rank（任意）",
    },
}
